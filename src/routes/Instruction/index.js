...
import TargetDetection from './TargetDetection'
import FaceDetection from './FaceDetection'
import FuzzyReduction from './FuzzyReduction'
import OcclusionReduction from './OcclusionReduction'
...
export default class Index extends React.PureComponent {
  ...
  getCurrentComponent() {
    const componentMap = {
      ...
      'fuzzy-reduction': FuzzyReduction,
      'occlusion-reduction': OcclusionReduction
    };
          ...
          <Sider>
            ...
            >
              ...
              <Menu.ItemGroup title="计算机视觉能力">
                ...
                <Menu.Item key="target-detection">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;目标检测</Menu.Item>
                <Menu.Item key="face-detection">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;人脸检测</Menu.Item>
                <Menu.Item key="fuzzy-reduction">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;图像模糊还原</Menu.Item>
                <Menu.Item key="occlusion-reduction">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;图像遮挡还原</Menu.Item>
              </Menu.ItemGroup>
            </Menu>
          </Sider>
        </Card>
