...
const requestBasicData = [{
    param: 'URL',
    value: 'http://aiop.bupt.com/restapi/image/v1/target_detection',
}, {
    param: 'Method',
    value: 'POST',
}, {
...
@Form.create()
export default class TargetDetection extends React.Component {
        ...
        this.props.form.validateFields({ force: true },
            (err) => {
                if (!err) {
                    ...
                    this.props.dispatch({ type: 'instruction/invokeTargetDetection', payload: { img: pureImg } });
                }
            }
        );
    }
    ...
    render() {
        ...
        return (
            <div>
                ...
                <h2>接口描述</h2>
                <p>识别并定位rgb图像中的物体，包括飞机、自行车、船、瓶子、公交车、汽车、猫、椅子、牛、餐桌、狗、马、摩托车、人、盆栽、羊、沙发、火车以及电视屏幕。</p>
                ...
                <Row gutter={10}>
                    <Col span={5}>
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Item label="待检测图像" {...formItemLayout}>
                                <Upload
                                    name="file"
                    ...
                    <Col span={5}>
                        <Form.Item label="标注图像" {...formItemLayout}>
