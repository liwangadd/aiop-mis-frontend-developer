...
const requestBasicData = [{
    param: 'URL',
    value: 'http://aiop.bupt.com/restapi/image/v1/fuzzy_reduction',
}, {
    param: 'Method',
    value: 'POST',
}, {
...
@Form.create()
export default class FuzzyReduction extends React.Component {
        ...
        this.props.form.validateFields({ force: true },
            (err) => {
                if (!err) {
                    ...
                    this.props.dispatch({ type: 'instruction/invokeFuzzyReduction', payload: { img: pureImg } });
                }
            }
        );
    }
                ...
                <Row gutter={10}>
                    <Col span={5}>
                        <Form onSubmit={this.handleSubmit}>
                            <Form.Item label="模糊图像" {...formItemLayout}>
                                <Upload
                                    name="file"
