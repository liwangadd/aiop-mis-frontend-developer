      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            component: dynamicWrapper(app, ['instruction'], () => import('../routes/Instruction/TargetDetection')),
          },
          {
            path: 'face-detection',
            component: dynamicWrapper(app, ['instruction'], () => import('../routes/Instruction/FaceDetection')),
          },
          {
            path: 'fuzzy-reduction',
            component: dynamicWrapper(app, ['instruction'], () => import('../routes/Instruction/FuzzyReduction')),
          },
          {
            path: 'occlusion-reduction',
            component: dynamicWrapper(app, ['instruction'], () => import('../routes/Instruction/OcclusionReduction')),
          },
        ],
      },
      {
